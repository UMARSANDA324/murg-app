...
$order_query = $con->query("SELECT * FROM orders WHERE orderID='$orderId' LIMIT 1");
$order_row = $order_query->fetch_array();

$first_store_query = mysqli_query($con, "SELECT s.store_name FROM orders o LEFT JOIN stocks st ON o.stockID = st.id LEFT JOIN stores s ON st.store_id = s.id WHERE o.orderID='$orderId' ORDER BY o.id ASC LIMIT 1");
...
<body>
    ...
    <div class="receipt-container">
        ...
        <div class="meta-section">
            ...
            <div class="meta-row">
                ...
                <span class="meta-value"><?php echo htmlspecialchars(!empty($order_row['buyer_name']) ? $order_row['buyer_name'] : ($order_row['customer_name'] ?: 'Retail Customer')); ?></span>
            </div>
            <div class="meta-row">
    ...
    <div class="receipt-container copy-2">
        ...
        <table class="items-table">
            ...
            <tbody>
                <?php
                $sql2 = mysqli_query($con, "SELECT * FROM orders WHERE orderID='$orderId'");
                $copy2TotalQty = 0;
